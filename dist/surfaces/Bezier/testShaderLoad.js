...
var ProjectionMapper = /** @class */ (function () {
    ...
    ProjectionMapper.prototype.initPMapperShader = function () {
    ...
    ProjectionMapper.prototype.createQuadMap = function (w, h, res) {
        ...
        var s = new QuadMap_1.default(this.surfaces.length, w, h, res, this.buffer);
    ...
    ProjectionMapper.prototype.createTriMap = function (w, h, res) {
        if (res === void 0) { res = 20; }
        var s = new TriMap_1.default(this.surfaces.length, w, h, res, this.buffer);
        this.surfaces.push(s);
        return s;
    };
    ProjectionMapper.prototype.createLineMap = function (x0, y0, x1, y1) {
        ...
        var l = new LineMap_1.default(x0, y0, x1, y1, this.lines.length);
        this.lines.push(l);
        return l;
    };
    ProjectionMapper.prototype.createPolyMap = function (numPoints) {
        ...
        if (numPoints < 3)
            numPoints = 3;
        var s = new PolyMap_1.default(this.surfaces.length, numPoints, this.buffer);
        this.surfaces.push(s);
        return s;
    };
    ProjectionMapper.prototype.createBezierMap = function (numPoints) {
        ...
        var bez = new BezierMap_1.default(this.surfaces.length, numPoints, this.pInst, this);
    ...
    // LOADING / SAVING
    ////////////////////////////////////////
    ProjectionMapper.prototype.load = function (filepath) {
