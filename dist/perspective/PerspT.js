...
function getNormalizationCoefficients(srcPts, dstPts, isInverse) {
    ...
    var matC;
    try {
        matC = numeric_1.default.inv(numeric_1.default.dotMMsmall(numeric_1.default.transpose(matA), matA));
    }
    catch (e) {
        console.log(e);
        return [1, 0, 0, 0, 1, 0, 0, 0];
    }
    var matD = numeric_1.default.dotMMsmall(matC, numeric_1.default.transpose(matA));
    var matX = numeric_1.default.dotMV(matD, matB);
