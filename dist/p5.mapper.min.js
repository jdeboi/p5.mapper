...
var BezierMap = /*#__PURE__*/function (_Surface) {
  ...
  function BezierMap(id, numPoints, pInst, pMapper) {
    ...
    _this.width = 100;
    _this.height = 100;
    _this.contentImg = createImage(_this.width, _this.height); // this.maskImg = createImage(this.width, this.height);
  ...
  ProjectionMapper_createClass(ProjectionMapper, [{
    ...
    value: function init(w, h) {
      ...
      if (this.bezBuffer == null) {
        ...
        var filePath = "../../src/surfaces/Bezier/shader";
        this.bezShader = this.pInst.loadShader(filePath + ".vert", filePath + ".frag", function () {
          return _this.bezierShaderLoaded = true;
        });
      }
    } ////////////////////////////////////////
    // SURFACES
