...
var ControlPoint = /*#__PURE__*/function () {
  ...
  BezierPoint_createClass(ControlPoint, [{
    ...
    value: function displayControlCircle() {
      var strokeC = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : color(255, 0, 0);
      var i = this.parentPath.points.indexOf(this);
      stroke(strokeC);
      strokeWeight(2);
    ...
    value: function displayCircle(col, r) {
      ...
      noStroke();
      fill(col);
      ellipse(this.pos.x, this.pos.y, r); // const i = this.parentPath.points.indexOf(this);
...
var BezierMap = /*#__PURE__*/function (_Surface) {
  ...
  function BezierMap(id, numPoints, pInst, pMapper) {
    ...
    _this.width = 100;
    _this.height = 100; // this.contentImg = createImage(this.width, this.height);
  ...
  BezierMap_createClass(BezierMap, [{
    ...
    value: function setDimensions() {
      ...
      this.height = h + this.bufferSpace * 2; // this.contentImg.resize(this.width, this.height);
    ...
    value: function addSegment(x, y) {
      ...
      var nextClosestAnchorId = this.getNextClosestAnchor(); // this.toggleClosed();
      ...
      var nextAnchor = this.points[nextClosestAnchorId].pos;
      ...
      var control1 = p5.Vector.lerp(prevControl, anchor, 1 - .3);
    ...
    value: function displayGraphicsTexture(pBuffer) {
      ...
      var theShader = this.pMapper.bezShader;
      ...
      pOutput.rect(0, 0, width, height); // // TODO - issue with createImage() and createGraphics()
    ...
    key: "displayGraphicsTextureOG",
    value: function displayGraphicsTextureOG(pg) {
      // white bezier mask should be recreated every time 
      // shape changes (this.setDimensions())
    ...
    value: function displayBezierPG(pg) {
      var _this$getBounds4 = this.getBounds(),
          x = _this$getBounds4.x,
          y = _this$getBounds4.y;
...
p5.prototype.initPMapperShader = function () {
  ...
  var filePath = "https://cdn.jsdelivr.net/gh/jdeboi/p5.mapper@latest/src/surfaces/Bezier/shader";
  this.loadShader(filePath + ".vert", filePath + ".frag", function (bezShader) {
    return pMapper.preload(bezShader);
  });
};

p5.prototype.registerMethod('init', p5.prototype.initPMapperShader); // p5.prototype.registerMethod('pre', () => pMapper.beginSurfaces());
