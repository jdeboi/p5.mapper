...
function getPercent(p5) {
  ...
  seconds = p5.constrain(seconds, .1, 100); // 60 frames / second
...
function getPercentWave(p5) {
  ...
  var per = .5 + .5 * p5.sin(p5.frameCount / (60 * seconds) * 2 * p5.PI + offset);
  return per;
}
function isWEBGL(p5) {
...
var QuadMap = /*#__PURE__*/function (_CornerPinSurface) {
  ...
  function QuadMap(id, w, h, res, buffer, pInst) {
    ...
    return _super.call(this, id, w, h, res, "QUAD", buffer, pInst);
  }
  /**
...
var PolyMap = /*#__PURE__*/function (_Surface) {
  ...
  function PolyMap(id, numPoints, buffer, pInst) {
    ...
    for (var i = 0; i < numPoints; i++) {
      ...
      var y = r + r * Math.sin(i / numPoints * 2 * _this.pInst.PI); // if (!isWEBGL(this.pInst)) {
      //     x += width / 2;
      //     y += height / 2;
      // }
